    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("SHA256 IS: " + driver.findElement(By.id("copyResult")).getAttribute("innerHTML")
                    + "NEW NONCE:" + newNonce);
            if (myHash.substring(0, 3).equals("000")) {
                System.out.println("THREE ZEROS IS DONE!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
            } else if (myHash.substring(0, 4).equals("0000")) {
                System.out.println("FORE 4444 IS DONE, MY CONGRATULATIONS!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
            } else if (myHash.substring(0, 6).equals("000000")) {
                System.out.println("SIX IS DONE, MY CONGRATULATIONS!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
            } else if (myHash.substring(0, 5).equals("00000")) {
                break;
            }
        }
    }
